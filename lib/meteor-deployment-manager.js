...
mdm.startDeploy = function () {
  ...
  commands.push({ cmd: 'echo "Installing fibers on programs/server" && cd builds/current/bundle/programs/server && npm install fibers ', output:'Installing fibers', quiet:false});
